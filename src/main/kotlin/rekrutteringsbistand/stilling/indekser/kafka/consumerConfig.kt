...
private val serviceuserUsername: String = environment().get("SERVICEUSER_USERNAME")
private val serviceuserPassword: String = environment().get("SERVICEUSER_PASSWORD")
